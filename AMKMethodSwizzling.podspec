...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "mengxinxin"
  # s.authors            = { "mengxinxin" => "andy_m129@163.com" }
  # s.social_media_url   = "http://twitter.com/mengxinxin"
  ...
  s.source_files  = "AMKMethodSwizzling", "AMKMethodSwizzling/**/*.{h,m}"
